...
VARIABLES_NAMES=("REMOTE_HOST" "REMOTE_USER" "REMOTE_CLIENT" "REMOTE_WEB" "LOCAL_CLIENT" "LOCAL_WEB")
...
#BUILD PATHS
REMOTE_PATH="/var/www/clients/client$REMOTE_CLIENT/web$REMOTE_WEB/web"
...
#FILES PERMISSIONS
chown -R web$LOCAL_WEB:client$LOCAL_CLIENT $LOCAL_PATH/web/*
